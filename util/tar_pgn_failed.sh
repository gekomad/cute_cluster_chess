...
find $home -name "*.pgn" | grep -f $tmp_folder/failed.txt |xargs -I {} cp {}  $tmp_folder/cute_pgn/
find $home -name "cute_$id.log" | grep -f $tmp_folder/failed.txt |xargs -I {} cp {}  $tmp_folder/cute_pgn/
find $home -name "cute_$id.err" | grep -f $tmp_folder/failed.txt |xargs -I {} cp {}  $tmp_folder/cute_pgn/
